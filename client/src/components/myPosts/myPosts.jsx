...
const MyPosts = () => {
    const { userPosts, commentOfPost, postComment, setFilterCommentData, filterCommentData, setPostComment } =
...
=======
    return (
        <div className="myPosts">
            <div className="myPostsHedear">
                <ConstructionIcon /> התקלות שלי
>>>>>>> def6fa3aea27f2b0182311b716b2292b90cd5d1a
            </div>
            {userPosts.map((post, index) => {
                return (
                    <div key={index}>
                        ...
                        >
                            <div className="commentComments">
                                <button onClick={() => setFilterCommentData({})}> נקה סינונים </button>
                                <button
                                    onClick={() => {
